...
static const void startup()
  ...
  system("feh --bg-fill \"/home/veeloth/main/wallpapers/bg.png\"");
  system("nhkd &disown");
...
/* tagging */
static const char *tags[] = { "fl", "dv", "wk", "gm", "ch", "re", "br", "ob", "bt" };
...
static const Layout layouts[] = {
	...
	{ "fibo",      spiral },   /* first entry is default */
	{ "grid",      grid },
	{ "mono",      monocle },
	{ "bsta",      bstack },
	{ "squa",      nrowgrid},
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_focus, "-sf", col_gray4, NULL };
